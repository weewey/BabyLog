...
/// A single turn returned by `BabyLogAssistant.respond(to:)`. May carry
...
/// Typed error surface for `BabyLogAssistant` implementations. Callers switch on
...
public protocol BabyLogAssistant: Sendable {
